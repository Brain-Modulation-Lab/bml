function filtered = bml_annot_filterout(cfg, annot, filter_annot)

% BML_ANNOT_FILTEROUT returns the annots that don't intersect with the filter
%
% Use as
%   filtered = bml_annot_filterout(cfg, annot, filter_annot);
%   filtered = bml_annot_filterout(annot, filter_annot);
%
