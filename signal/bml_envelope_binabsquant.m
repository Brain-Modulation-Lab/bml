function env = bml_envelope_binabsquant(cfg, data)

% BML_ENVELOPE_BINABSQUANT envelope as quantile of absolute value in bin
%
% The envelope is calculated as the quantile of the absolute value in
% bins of 'bin_size' samples. 
%
% Use as
%   env = bml_envelope_binabsquant(data)
%   env = bml_envelope_binabsquant(cfg, data)
%
...
% cfg.quantile - numeric in [0,1]. Defaults to 0.95
%
...
q               = bml_getopt(cfg,'quantile',0.95);    
